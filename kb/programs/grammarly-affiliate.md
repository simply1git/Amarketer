...
confidence:
  level: medium
  basis: consistent across three third-party directories; not yet confirmed in program dashboard — re-verify at signup
related: [seo-content-site, ftc-disclosure]
ai_instructions: Do not quote these rates in published content until status is verified after owner signup.
---

# Grammarly Affiliate Program

- **Commissions (indicative):** $0.20 per free account signup; $20 per premium purchase. CPA model, not recurring.
