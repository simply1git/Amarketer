...
summary: >
  ...
  in 2026; access may require an affiliate network intermediary.
source:
  origin: https://www.notion.com/affiliates (status and terms cross-checked via linkjolt.io and commissiondex.com)
...
confidence:
  level: medium
  basis: 50%/12mo terms widely corroborated; the closed-to-new-applicants report needs direct confirmation before signup attempt
related: [seo-content-site, ftc-disclosure]
ai_instructions: Confirm application status directly at notion.com/affiliates before proposing signup; do not rely on network intermediaries without checking their payout terms.
---
